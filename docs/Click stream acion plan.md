...
**4. Dual CTAs in the bottom banner have identical visual hierarchy**
...
**5. No lead capture before the full quote form**
...
**6. `/servicios` and `/nosotros` have no connection to the quote flow**
